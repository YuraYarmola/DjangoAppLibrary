...
class CustomUser(AbstractBaseUser):
    ...
    middle_name = models.CharField(max_length=20, default='user')
    ...
    def __str__(self):
        ...
        """
        return f"{self.first_name} {self.last_name}"  # 'password': '{self.password}', \
    ...
    def get_absolute_url(self):
        return reverse('one_user', kwargs={'user_id': str(self.id)})
