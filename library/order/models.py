...
class Order(models.Model):
    """
           ...
           param created_at: Describes the date when the user_order was created. Can't be changed.
    ...
    def to_dict(self):
        """
                :return: user_order id, book id, user id, user_order created_at, user_order end_at, user_order plated_end_at
                :Example:
                | {
                |   'id': 8,
                |   'book': 8,
